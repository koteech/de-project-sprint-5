...
from st03_dds.dm_couriers_stg_to_dds_dag.events_loader import courierLoader
...
@dag(
    ...
    tags=['de_project_sprint5', 'couriers', 'dds'],  # Теги, используются для фильтрации в интерфейсе Airflow.
    is_paused_upon_creation=True  # Остановлен/запущен при появлении. Сразу запущен.
)
def st03_02_de_project_sprint5_couriers_stg_to_dds_dag():
...
init_dag = st03_02_de_project_sprint5_couriers_stg_to_dds_dag()  # noqa
